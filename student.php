 ...
 $row = mysqli_fetch_array($result);
           ...
           echo '     
                <div id = "std_prof">
                    ...
                    <div class ="std_inf_box"> credit: '.$row['tot_cred'].'  </div>
        ...
        $sql = "SELECT * FROM takes where ID = '$id' ";
        $result = mysqli_query ($conn,$sql);
        ...
        $result2 = mysqli_query ($conn,$sql2);
         ...
         $row2 = mysqli_fetch_array($result2) ;
            ...
            echo'
               ...
               <a href ="loadcourse.php?crs='.$row['course_id'].'"> <button type="button" id  ="show_students" onclick="cs_show()">  check out course details   </button></a>
                </div>
